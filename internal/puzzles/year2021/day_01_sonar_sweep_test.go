...
func TestSonarSweepPart1Sample(t *testing.T) {
	expected := 7
	actual := SonarSweepPart1(year2021data.SonarSweepSampleData)
...
func TestSonarSweepPart1Puzzle(t *testing.T) {
	expected := 1553
	actual := SonarSweepPart1(year2021data.SonarSweepPuzzleData)
	utils.AssertAreEqual(t, expected, actual)
}
...
func TestSonarSweepPart2Sample(t *testing.T) {
	expected := 5
	actual := SonarSweepPart2(year2021data.SonarSweepSampleData)
	utils.AssertAreEqual(t, expected, actual)
}
...
func TestSonarSweepPart2Puzzle(t *testing.T) {
	expected := 1597
	actual := SonarSweepPart2(year2021data.SonarSweepPuzzleData)
	utils.AssertAreEqual(t, expected, actual)
}
